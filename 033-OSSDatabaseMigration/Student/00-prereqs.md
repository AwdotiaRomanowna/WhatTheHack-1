...
* Explore the user contosoapp that owns the application objects and its security privileges. In later challenges, this user and the database needs to be created on the target database.
